...
%
% MoML 2026 (MIT) short paper. 2-4 pages excl. references/appendix;
% non-archival, non-anonymous, simultaneous submission permitted.
% Self-contained: compiles with pdflatex + bibtex (natbib).
% NOTE: needs one compile pass (Overleaf) before submission; no local TeX.
% =====================================================================
...
\node[anchor=north west, font=\scriptsize] at (rel axis cs:0.02,0.99)
  {leaky-codebook ceiling $\sim$48\%};
\end{axis}
\end{tikzpicture}
