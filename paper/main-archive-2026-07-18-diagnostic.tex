% ============================================================================
% ARCHIVED 2026-07-18 (Phase D). This is the DIAGNOSTIC version of the paper,
% submitted to Digital Discovery (desk-rejected, AE Jung, impact) and TMLR
% (desk-rejected, volume triage). Superseded by the METHOD reframe (deployable
% symmetry-coset conditioning). Preserved per archive-superseded-docs policy;
% git history alone is not a backup. Do not edit -- reference only.
% ============================================================================
% =====================================================================
...
Cambridge Structural Database (CSD)\cite{groom2016csd} and are governed by the
CSD licence. The underlying CIF structures, and the factorized tensors derived
from them (lattice, centroid, and orientation representations), are derived from
licence-restricted data and cannot be redistributed under the terms of that
licence; this is the sole reason these primary data are not openly deposited.
...
selection metadata (formula, $Z'$, R-factor, atom count, and space group), is
openly available as \texttt{data/csd\_mol/manifest.csv} in the archived code
repository (see Code availability). The export and factorization pipeline that
regenerates the exact CIF corpus and derived tensors from a licensed CSD
installation is provided as \texttt{scripts/csd\_export.py} and
\texttt{scripts/factorize\_cifs.py} in the same repository, and a fixed random
seed reproduces the identical $964/131$ train/validation split used throughout.
No other primary datasets were generated in this work; additional data
supporting the results are provided in the SI.
...
export and factorization scripts referenced above---are available at
\url{https://github.com/fronkt/symmc-flow} and are permanently archived at
Zenodo.\cite{cai2026symmcflow} The version underlying this study is v1.0.3
(DOI \href{https://doi.org/10.5281/zenodo.21384130}{10.5281/zenodo.21384130});
the concept DOI
\href{https://doi.org/10.5281/zenodo.20822234}{10.5281/zenodo.20822234}
